...
const Footer = () => {
  return (
    <div class="w-full min-h-[50vh] flex items-center justify-center bg-gray-400  font-Montserat overflow-x-hidden ">
        <div class="md:w-2/3 w-full px-4 text-white flex flex-col">
            ...
            <div class="flex flex-col">
                <div class="flex mb-4 flex-row justify-between">
                    ...
                    <a class="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase transition duration-200">Why us</a>
                    <a class="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase transition duration-200">Contact</a>
