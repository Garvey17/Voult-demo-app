  ...
  return (
    <div>
        <section class="bg-white py-8 antialiased md:py-12">
            ...
            <div>
                <h2 class="mt-3 text-xl font-semibold text-black sm:text-2xl">Shoes</h2>
            </div>
            ...
            <div class="mb-4 grid gap-10 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">


                <div class="rounded-lg border border-gray-200 bg-[#DDE6E7] p-6 shadow-sm dark:border-gray-700">
                    <div class="h-56 w-full">
                    <a href="#">
                        <img class="mx-auto h-full rounded-lg" src={samba1} alt="" />
                    ...
                    <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Adidas Samba OG blue men's</a>
                    ...
                    <div class="mt-4 flex items-center justify-between gap-4">
                        <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">$99.95</p>

                        <button type="button" class="inline-flex items-center rounded-full  bg-[#1FA180] hover:bg-[#306456] px-5 py-2.5 text-sm font-medium text-white focus:outline-none focus:ring-4  focus:ring-primary-300 dark:focus:ring-primary-800">
                ...
                <div class="rounded-lg border border-gray-200 bg-[#DDE6E7] p-6 shadow-sm dark:border-gray-700">
                    <div class="h-56 w-full">
                    <a href="#">
                        <img class="mx-auto h-full rounded-lg " src={samba2} alt="" />
                    ...
                    <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Adidas Samba OG men's</a>
                ...
                <div class="rounded-lg border border-gray-200 bg-[#DDE6E7] p-6 shadow-sm dark:border-gray-700">
                    <div class="h-56 w-full">
                    <a href="#">
                        <img class="mx-auto h-full rounded-lg" src={samba3} alt="" />
                    ...
                    <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Adidas Samba Classic men's</a>
                    ...
                    <div class="mt-4 flex items-center justify-between gap-4">
                        <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">$89.99</p>
                ...
                <div class="rounded-lg border border-gray-200 bg-[#DDE6E7] p-6 shadow-sm dark:border-gray-700">
                    <div class="h-56 w-full">
                    <a href="#">
                        <img class="mx-auto h-full rounded-lg" src={samba4} alt="" />
                    ...
                    <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Adidas Samba OG shoes</a>
                    ...
                    <div class="mt-4 flex items-center justify-between gap-4">
                        <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">$100</p>
                ...
                <div class="rounded-lg border border-gray-200 bg-[#DDE6E7] p-6 shadow-sm dark:border-gray-700">
                    <div class="h-56 w-full">
                    <a href="#">
                        <img class="mx-auto h-full rounded-lg" src={samba5} alt="" />
                    ...
                    <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Sneaker Adidas Samba</a>
                    ...
                    <div class="mt-4 flex items-center justify-between gap-4">
                        <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">$120.99</p>
                ...
                <div class="rounded-lg border border-gray-200 bg-[#DDE6E7] p-6 shadow-sm dark:border-gray-700">
                    <div class="h-56 w-full">
                    <a href="#">
                        <img class="mx-auto h-full rounded-lg" src={samba6} alt="" />
                    ...
                    <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Adidas samba OG shoes men</a>
                    ...
                    <div class="mt-4 flex items-center justify-between gap-4">
                        ...
                        <button type="button" class="inline-flex items-center rounded-full bg-[#1FA180] hover:bg-[#306456] px-5 py-2.5 text-sm font-medium text-white  focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                        <svg class="-ms-2 me-2 h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4h1.5L8 16m0 0h8m-8 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm8 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm.75-3H7.5M11 7H6.312M17 4v6m-3-3h6" />
                        </svg>
                        Add to cart
